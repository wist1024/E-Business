 ...
 * on handsets.
 */
public class StockMarketChartFragment extends Fragment {
    /**
    ...
    public static StockMarketChartFragment newInstance() {

        StockMarketChartFragment fragment = new StockMarketChartFragment();
     ...
     */
    public StockMarketChartFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Show the dummy content as text in a TextView.
            ((ImageView)rootView.findViewById(R.id.share_detail)).setImageResource(mItem.details2);
