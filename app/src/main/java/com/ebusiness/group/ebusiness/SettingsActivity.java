...
public class SettingsActivity extends AppCompatPreferenceActivity
    ...
    public static class FeedbackFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            Preference button = (Preference)findPreference(getString(R.string.sendButton));
            button.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                @Override
                public boolean onPreferenceClick(Preference preference) {
                    //startActivity(new Intent(getActivity(), MailService.class));
                    ...
                    //        });
                    builder.setMessage("thanks, you sent the feedback successfully ");
